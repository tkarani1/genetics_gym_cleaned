...
# am1 = hl.read_table('gs://genetics-gym-not-public/Trisha/hail_VSM_tables_updated/AM_isos.ht')
# am1 = am1.key_by('enst', 'aa_pos', 'aa_ref', 'aa_alt')
# am1 = am1.select(am1.AM)
# am1 = am1.checkpoint(f'gs://trisha-tmp/new_VSM_temp/AM_isos_keyed.ht', overwrite=True)

# am2 = hl.read_table('gs://genetics-gym-not-public/Trisha/hail_VSM_tables_updated/AM.ht')
# am2 = am2.annotate(
#     enst = am2.enst_orig.split('\.')[0], 
# )
...
# vsm_ht = vsm_ht.key_by('enst', 'aa_pos', 'aa_ref', 'aa_alt')
# vsm_ht = vsm_ht.join(am1, how='left')
# vsm_ht = vsm_ht.key_by('locus', 'alleles', 'enst')
# vsm_ht = vsm_ht.join(am2, how='left')
# vsm_ht = vsm_ht.checkpoint(f'gs://trisha-tmp/new_VSM_temp/vsm_am.ht', overwrite=True)

# vsm_ht.show()

# vsm_ht = hl.read_table('gs://trisha-tmp/new_VSM_temp/vsm_am.ht')
# vsm_ht = vsm_ht.annotate(
#     AM_comb = hl.coalesce(vsm_ht.AM_score, vsm_ht.AM)
# )
# vsm_ht = vsm_ht.checkpoint(f'gs://trisha-tmp/new_VSM_temp/vsm_am_comb.ht', overwrite=True)
vsm_ht = hl.read_table('gs://trisha-tmp/new_VSM_temp/vsm_am_comb.ht')

results = check_score_completenes(vsm_ht, 'AM_comb')
print('Method: ', method)
print(results)
